...
"""
This module contains svr code to tune the models. 
...
def train_svr_model_pipeline(X, y, categorical_columns, numerical_columns, cv=5):
    """
    Train a Support Vector Regression (SVR) model with preprocessing and cross-validation.
